				...
				<div class="box-top">Data Admin</div>
					<div class="box-panel">
			      		<table width="100%" align="center" border=0 bordercolor="#FFFFFF">
							<td valign="top"><p class="judul">HAPUS ADMIN</p>
						<?php
							...
							if($res){
							?>
								<div class="info">Data Admin dengan Username <?php echo $username;?> telah dihapus.</div>
								<?php
							}
							else {
							?>
								<div class="error">Data admin dengan Username <?php echo $username;?> gagal dihapus dengan pesan kesalahan <b>
